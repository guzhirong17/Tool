package com.gzr.tool.util;

import android.content.Context;
import android.content.SharedPreferences;

import com.gzr.tool.MyApplication;
import com.gzr.tool.constants.Constants;
...
public class SharePref
{
    ...
    {
        return MyApplication.getInstance().getSharedPreferences(Constants.BASE_PROJECT, Context.MODE_PRIVATE);
    }
}
